...
variable "network_zone" {
  description = "Hetzner Cloud network zone. Must match the location's region."
  type        = string
  default     = "eu-central"
  nullable    = false
...
variable "subnet_ip_range" {
  description = "IP range for the subnet in CIDR notation. Must be within network_ip_range."
  type        = string
  default     = "10.0.1.0/24"
  nullable    = false
}
