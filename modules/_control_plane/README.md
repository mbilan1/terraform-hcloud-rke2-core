...
| Name | Type |
|------|------|
| [hcloud_server.initial](https://registry.terraform.io/providers/hetznercloud/hcloud/latest/docs/resources/server) | resource |
| [hcloud_server.joining](https://registry.terraform.io/providers/hetznercloud/hcloud/latest/docs/resources/server) | resource |
| [hcloud_server_network.initial](https://registry.terraform.io/providers/hetznercloud/hcloud/latest/docs/resources/server_network) | resource |
| [hcloud_server_network.joining](https://registry.terraform.io/providers/hetznercloud/hcloud/latest/docs/resources/server_network) | resource |
...
| <a name="input_network_id"></a> [network\_id](#input\_network\_id) | Hetzner network ID for private networking. | `number` | n/a | yes |
...
| <a name="input_rke2_version"></a> [rke2\_version](#input\_rke2\_version) | RKE2 version to install. | `string` | `"v1.32.2+rke2r1"` | no |
